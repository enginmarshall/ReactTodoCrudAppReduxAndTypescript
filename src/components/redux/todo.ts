...
// They perform CRUD and also toggle todo.Redux - Toolkit uses Immutable.js which allows us to mutate
// state but on the background everything works as immutated state.
